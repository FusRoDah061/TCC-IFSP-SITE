function LoadJSCodeBlob(e, t) {
    ...
    //n.src = 'thirdparty/vlibras/target/blob.js';
    n.onload = t,
...
try {
    ...
    testRequest.onsuccess = function() {
        ...
        SetIndexedDBAndLoadCompressedJS(idb)
    }
    ,
    setTimeout(function() {
        SetIndexedDBAndLoadCompressedJS()
    ...
    return function e(t, n, o) {
        ...
        8: [function(e, t, n) {
            ...
            function s(e, t) {
                ...
                t = -t) : (n = (t >> 4) + 1,
                48 > t && (t &= 15)),
                t && (8 > t || t > 15) ? F : (null !== o.window && o.wbits !== t && (o.window = null),
                o.wrap = n,
                o.wbits = t,
                r(e))) : F
            }
            ...
            function f(e, t) {
                ...
                e: for (; ; )
                    ...
                    case q:
                        if (2048 & n.flags) {
                            ...
                            while (_e && d > w);if (512 & n.flags && (n.check = v(n.check, i, w, r)),
                            d -= w,
                            r += w,
                            _e)
                                break e
                    ...
                    case de:
                        if (n.wrap) {
                            ...
                            e.total_out += m,
                            n.total += m,
                            m && (e.adler = n.check = n.flags ? v(n.check, a, m, s - m) : g(n.check, a, m, s - m)),
                            m = l,
                ...
                n.hold = f,
                n.bits = h,
                (n.wsize || m !== e.avail_out && n.mode < ce && (n.mode < de || t !== M)) && c(e, e.output, e.next_out, m - e.avail_out) ? (n.mode = fe,
                A) : (p -= e.avail_in,
                m -= e.avail_out,
                e.total_in += p,
                e.total_out += m,
        ...
        9: [function(e, t, n) {
            ...
            t.exports = function(e, t, n, p, m, w, b, g) {
                ...
                return 0 !== z && (m[S + z] = R - O << 24 | 64 << 16 | 0),
                g.bits = A,
                0
            }
        }
        ...
        "/lib/inflate.js": [function(e, t, n) {
            ...
            h.prototype.push = function(e, t) {
                ...
                } while (c.avail_in > 0 && n !== d.Z_STREAM_END);return n === d.Z_STREAM_END && (o = d.Z_FINISH),
...
function() {
    var e = function(e) {
        ...
        function n() {
            ...
            new t(0,4165551,0,0).open("GET", "/data.unity3d"),
            new t(4165551,4165572,0,0).open("GET", "/methods_pointedto_by_uievents.xml"),
            new t(4165572,4168787,0,0).open("GET", "/preserved_derived_types.xml"),
            new t(4168787,7079451,0,0).open("GET", "/Il2CppData/Metadata/global-metadata.dat"),
            new t(7079451,7954423,0,0).open("GET", "/Resources/unity_default_resources"),
            new t(7954423,7982048,0,0).open("GET", "/Managed/mono/2.0/machine.config"),
