<template lang="pug">
    div.login
        ...
        form#js-frm-login.form.col-md-8.offset-md-2
            div.form-inputs
            ...
            router-link(to="/recuperar").d-block.text-right Esqueci minha senha

            button.btn.btn-green.mt-4.mb-4.btn-block Acessar

            router-link(to="/cadastrar").btn.btn-white.mt-4.mb-4.btn-block Não tenho uma conta
</template>
